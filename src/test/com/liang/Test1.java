...
public class Test1 {
	...
	public void test() throws IOException, TesseractException {
		...
		BufferedImage bi = ImageHelper.convertImageToGrayscale(ImageHelper.getSubImage(panel.image, startX, startY, endX, endY));  
		// 图片锐化,自己使用中影响识别率的主要因素是针式打印机字迹不连贯,所以锐化反而降低识别率  
		// bi = ImageHelper.convertImageToBinary(bi);  
		// 图片放大5倍,增强识别率(很多图片本身无法识别,放大5倍时就可以轻易识,但是考滤到客户电脑配置低,针式打印机打印不连贯的问题,这里就放大5倍)  
		bi = ImageHelper.getScaledInstance(bi, endX * 5, endY * 5); 
